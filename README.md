Эта программа сначала выводит на экран сообщение на Английском языке "Hello World!!", а потом с помощью setlocale выводит сообщение на экран на русском языке "Привет!!"
